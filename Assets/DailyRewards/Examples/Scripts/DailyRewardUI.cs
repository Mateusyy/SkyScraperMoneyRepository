...
namespace NiobiumStudios
{
    ...
    public class DailyRewardUI : MonoBehaviour
    {
        ...
        public Sprite claimSprite;            // The Color of the background when claimed
        public Color colorUnclaimed;       // The Color of the background when not claimed
        public Sprite unclaimSprite;       // The Color of the background when not claimed
        ...
        public void Refresh()
        {
            switch (state)
            {
                case DailyRewardState.UNCLAIMED_AVAILABLE:
                    imageRewardBackground.sprite = unclaimSprite;
                ...
                case DailyRewardState.CLAIMED:
                    imageRewardBackground.sprite = claimSprite;
                    break;
            }
        }
    }
